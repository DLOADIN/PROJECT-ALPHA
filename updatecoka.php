        ...
        <div class="header">
          ...
          <div class="grid-container">
            ...
            <?php
                  if(isset($_GET['id'])){
                  $id=$_GET['id'];}
                  $sql=mysqli_query($con,"SELECT * from coka WHERE id='$id' ");
              ...
              <form action="" method="post">
                ...
                <button type="button" class="btn-btn" onclick="barberNoah()">COKA</button>
                <br>
              ...
              $percentage = 0;// Set a default value or handle the case when no record is found
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                  ...
                  $query=mysqli_query($con,"UPDATE coka SET u_name='$name', u_amount='$amount', u_date='$date_field', u_customers='$customers', u_percentage='$newNumber' WHERE id='$id' ");
              }
                if($query){
