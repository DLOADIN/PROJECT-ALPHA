            ...
            <div class="form-box">
              ...
              <div class="right">
                <?php
                  ...
                  $sql=mysqli_query($con,"SELECT * FROM manager WHERE id='$id' ");
                  $row=mysqli_fetch_array($sql)
                  ?>
                <form action="" method="POST">
                  <h2 class="form-barber">UPDATE ADMIN CREDENTIALS</h2>
                  <label for="">NAMES</label>
                  <input type="text" name="u_name" class="field" placeholder="Name" value="<?php echo $row['u_name']?>">
                  <label for="">PASSWORD</label>
                  <input type="text" name="u_password" class="field" placeholder="Password" value="<?php echo $row['u_password']?>">
                ...
                $query=mysqli_query($con,"UPDATE manager SET u_name='$name', u_password='$password' WHERE id='$id' ");
                if($query){
