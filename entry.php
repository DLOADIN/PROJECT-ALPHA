      ...
      <div class="container">
        ...
        <div class="content">
          <div class="main-container">
            <div class="form-box">
              ...
              <form action="" method="POST">
                  ...
                  <input type="text" name="u_name" class="field" placeholder="Barber's Name" required>
                  
                  <label for="">PRODUCT NAME</label>
                  <select name="p_name"  class="field" required>
                  ...
                  <label for="">PRODUCT AMOUNT</label required>
                  <select name="p_amount" class="field">
                  ...
                  <input type="text" name="p_date" class="field" value="<?php echo date('Y-m-d')?>" >
                  ...
                  <?php
                     if(isset($_POST['submit'])){
                      ...
                      $sql=mysqli_query($con,"INSERT INTO productentry VALUES('','$name','$productname','$productamount','$date_field')");
                     }
                      ?>
                </form>
              </div>
          ...
          <div class="content-2">
              ...
              <button class="btn-2">
                <a href="entrypdf.php" class="a">PRINT</a>  
                </button>
              </div>
          </div>
        </div>
