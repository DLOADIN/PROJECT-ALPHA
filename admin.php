    ...
    <div class="side-menu">
      ...
      <div class="container">
        ...
        <div class="content">
          <div class="cards">
            <div class="card">
              <div class="box"><div class="icon-case">
                  <ion-icon name="cash-outline"></ion-icon>
                </div>
                <h1 class="font-text"><?php
                 $sql=mysqli_query($con,"SELECT * from `productentry`" );
               ...
               <tr>
                ...
                ?></h1>
                <h3 class="font-text">ENTRY RECORDS</h3>
              </div>
            </div>
            ...
            <div class="card">
              <div class="box"><div class="icon-case">
                ...
                <h1 class="font-text"><?php
                 $sql=mysqli_query($con,"SELECT * from purchases" );
                 if($row=mysqli_num_rows($sql));
                 { 
               ?>
               <tr>
                ...
                ?></h1>
                <h3 class="font-text">PURCHASE RECORDS</h3>
              </div>
            </div>
            ...
            <div class="card">
              <div class="box"><div class="icon-case">
               ...
               <tr>
                ...
                ?></h1>
                <h3 class="font-text">EXPENSES RECORDS</h3>
              </div>
            </div>
            ...
            <div class="card">
              <div class="box"><div class="icon-case">
               ...
               <tr>
                ...
                ?></h1>
                <h3 class="font-text">ADMIN RECORDS</h3>
              </div>
            </div>
          </div>
          <div class="content-2">
              <div class="recent-payments">
                ...
                <tr>
                  ...
                  <td>  
                    <button class="lebutton"><a href="expenses.php">MODIFY</a></button>
                  </td>
                  <td>
                  <?php
                }
              ...
              <div class="new-amounts"> 
                <div class="title">
                <h2 class="h2">PURCHASES DETAILS</h2>
                </div>
                <table><tr>
                    <th>ID</th>
                    <TH>NAME</TH>
                ...
                <tr>
                  ...
                  <td><?php echo $row['u_date']?></td>
                  <td>  
                    <button class="lebutton"><a href="purchases.php">VIEW</a></button>
                  </td>
                  <?php
                }
              }
              ...
              <div class="new-amounts"> 
                ...
                <h2 class="h2">ENTRY DATA</h2>
                  ...
                  <tr>
                    ...
                    <td>  
                      <button class="lebutton"><a href="entry.php">VIEW</a></button>
                    </td>
                    </td>
                    <?php
                  }
              ...
              <div class="new-amounts"> 
                ...
                <tr>
                  ...
                  <td>
                  <button class="lebutton"><a href="promotion.php">VIEW</a></button>
                  </td>
                  <?php
                }
              }
