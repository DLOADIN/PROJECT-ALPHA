          ...
          <div class="main-container">
            <div class="form-box">
              ...
              <?php
                  if(isset($_GET['id'])){
                  $id=$_GET['id'];}
                  $sql=mysqli_query($con,"SELECT * FROM promotion WHERE id='$id' ");
                  $row=mysqli_fetch_array($sql);
                ?>
              <form action="" method="POST">
                  <h2 class="form-barber">PROMO DETAILS</h2>
                  <label for="">CUSTOMER'S NAMES</label>
                  <input type="text" name="u_name" class="field" placeholder="Name" required value="<?php echo $row['u_name']?>">
                  <label for="">STARTING DATE/PROMOTION  START DATE</label>
                  <input type="date" name="u_currentdate" class="field" value="<?php echo $row['u_currentdate']?>">
                  <label for="">END DATE/PROMOTION EXPIRY DATE</label>
                  <input type="date" name="u_expiringdate" class="field" value="<?php echo $row['u_expiringdate']?>">
                  ...
                  <?php
                      if(isset($_POST['submit'])){
                        ...
                        $query=mysqli_query($con,"UPDATE promotion SET u_name='$name', u_currentdate='$currentdate', u_expiringdate='$expiringdate' WHERE id='$id' ");
                        if($query){
          ...
          <div class="content-2">
              <div class="recent-payments">
                ...
                <tr>
                  ...
                  <td>
                  <button class="lebutton"><a href="updatepromotion.php?id=<?php echo $row['id']?>">RE-ADD</a></button>
                  </td>
                  <?php
                }
              }
